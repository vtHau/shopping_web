...
<div class="app-main">
	...
	<div class="app-main__outer">
		...
		<div id="popup-chat">
			<?php
			$getInfoUser = $user->getUserByID($userID);
			if ($getInfoUser) {
				$result = $getInfoUser->fetch_assoc();
			...
			<div class="box-chat">
				<div class="header-chat">
					<div class="header-chat-avatar">
						<img src="uploads/avatars/<?php echo $result["userImage"] ?>" alt="">
					</div>
					<div class="header-chat-info">

						<div class="name"><?php echo $userFullName ?> <i class="fa fa-angle-down"></i></div>
				...
				<div class="footer-chat">
					...
					<div class="footer-chat-send" data-userid="<?php echo $userID ?>" data-userimage="<?php echo $userImage ?>">
